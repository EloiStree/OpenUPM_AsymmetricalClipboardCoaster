using System;
using UnityEngine;
public abstract class AsymCoasterConceptMono<T> : MonoBehaviour where T : IAssymentricCreateSignVerify, new()

{
    ...
    public IAsymmetricPrivateKeyHolderGet m_coasterPrivateKey;
